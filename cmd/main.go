...
import (
	...
	dummyv1alpha1 "github.com/sonalys/dummy-k8s-operator/api/v1alpha1"
	"github.com/sonalys/dummy-k8s-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1ccda4e4.interview.com",
