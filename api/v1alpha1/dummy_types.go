...
type DummyStatusType string

const (
	DummyStatusTypeUnkown  DummyStatusType = ""
	DummyStatusTypePending DummyStatusType = "Pending"
	DummyStatusTypeRunning DummyStatusType = "Running"
	DummyStatusTypeFailed  DummyStatusType = "Failed"
)

type DummyStatus struct {
	PodStatus DummyStatusType `json:"podStatus,omitempty"`
